...
export function PaginatedIssueComments(props) {
  ...
  const commentUses = issueForPaginatedComments?.comments?.edges?.map((item, idx) => <Comment key={item?.post?.id || idx} comment={item?.post} />);
  ...
  return (
    <>
      <div className="data-box">
        ...
        {authorUses}
        <h4>PaginatedIssueCommentsUses <LocationNode /></h4>
